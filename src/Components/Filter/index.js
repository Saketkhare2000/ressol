        ...
        <motion.div className="filter-body">
          <form action="">
            ...
            <div className="filter-group">
              <h3>City</h3>
              <div className="filter-item">
                <Select onChange={handleChangeCity} options={cityOptions} placeholder="City" openMenuOnClick={false} required />
            ...
            <div className="filter-group">
              ...
              <div className="filter-item">
                ...
                <div className="select-option">
                  <input type="radio" onChange={(e) => setProperty_Type(e.target.value)} name="property_type" id="property_type" value="PG/Hostel" />
                  <label htmlFor="property_type">PG/Hostel</label>
                </div>
              </div>
            </div>
